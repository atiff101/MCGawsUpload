...
export default function InstallationWizard({ onCancel, onSubmitted }) {
  ...
  return (
    <div className="form-wrapper">
      <button className="dash-back-link" onClick={onCancel}>
        ← Back to dashboard
      </button>
      ...
      {step === 1 && (
        <div>
          ...
          <div className="field">
            <label>UN/LOCODE or coordinates (optional)</label>
            <br />
            <input
              type="text"
              value={data.unLocode}
          ...
          <div className="field">
            <label>Commissioning year (optional)</label>
            <br />
            <input
              type="number"
          ...
          <div className="field">
            <label>EU CBAM Registry installation ID (if assigned)</label>
            <br />
            <input
              type="text"
        ...
        <div>
          ...
          <div className="field">
            ...
            <input
              ...
              onChange={(e) =>
                updateField("reportingPeriodStart", e.target.value)
              }
              className="field-control"
            />
          </div>
          ...
          <div className="field">
            ...
            <input
              ...
              onChange={(e) =>
                updateField("reportingPeriodEnd", e.target.value)
              }
              className="field-control"
            />
          </div>
          <div className="field">
            <label>Activity level - total tonnes produced *</label>
            <br />
            <input
              type="number"
          ...
          <div className="field">
            <label>Does this process consume CBAM goods as inputs? *</label>
            <br />
            <select
              value={data.consumesPrecursors}
              onChange={(e) =>
                updateField("consumesPrecursors", e.target.value)
              }
              className="field-control"
            >
            ...
            {data.consumesPrecursors === "yes" && (
              <p className="warning-text">
                ⚠️ Complex goods reporting not supported yet. Please contact
                MCG.
              </p>
            )}
          </div>
